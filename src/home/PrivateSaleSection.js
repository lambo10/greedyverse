...
const PrivateSaleSection = () => {
    return(
        <div className="container-fluid lb_hero_bg" data-v-2a374f33="">
            ...
            <div className="row h-100 p-3 lb_sale_section_padding" data-v-2a374f33="">
                
                 <div className="col-lg-6 lb_txt_center disapear_on_mobile" data-v-2a374f33="">
                    <div className="blackColor ml-2" data-v-2a374f33="">
                    <img src={game_logo} alt='greedyclans logo' className='lb_game_logo_img lb_game_logo' />
                ...
                <br/>
                   ...
                   <div className="col-lg-6 lb_txt_center" data-v-2a374f33="">
                    ...
                    <div
                    className="lb_sale2_section supercellmagic_font text-uppercase text-white mb-xl-0" data-v-2a374f33="">
                    <span className="">Presale is live!</span>
                </div>
                <div className='lb_txt_size_12 lb_padding_top_15 lb_txt_color_orange2'>Buy $GVERSE with BNB or stablecoins before price increase. Tokens will be available for claim at launch.</div>
               
               <div className='lb_padding_top_15'>

               <div class="lb_meter lb_animate">
                    <span className='lb_width'><span></span></span>
                </div>

                <div className='lb_txt_size_12 lb_padding_top_10 lb_txt_color_orange2 lb_txt_align_left'>Stage 5 progress: 87%</div>

                <div className='lb_txt_size_17 lb_padding_top_15 lb_txt_color_white2'>1 USDT = 30.77 $GVERSE</div>
                <div className='lb_txt_size_12 lb_padding_top_10 lb_txt_color_orange2'>Hurry before the end of presale!</div>
                ...
                <div className='lb_padding_top_10'> <a href='#'><div className='lb_saleBTN lb_game_logo'>Buy now</div></a></div>
                   ...
                   <div className="col-lg-6 lb_txt_center disapear_on_desktop" data-v-2a374f33="">
                    <div className="blackColor ml-2" data-v-2a374f33="">
                    <div className='lb_padding20'>
                    <div
                    className="lb_sale1_section supercellmagic_font text-uppercase text-white mb-xl-0 " data-v-2a374f33="">
