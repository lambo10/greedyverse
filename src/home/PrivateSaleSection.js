  ...
  return (
    <div className='container-fluid lb_hero_bg' data-v-2a374f33=''>
      <div className='row h-100 p-3 lb_sale_section_padding' data-v-2a374f33=''>
        ...
        <div className='col-lg-6 lb_txt_center' data-v-2a374f33=''>
          <Sale className='lb_salePanel lb_game_logo'>
            <div
              className='lb_sale2_section supercellmagic_font text-uppercase text-white mb-xl-0'
              data-v-2a374f33=''
            >
            ...
            <div className='lb_padding_top_15'>
              ...
              <div className='lb_txt_size_12 lb_padding_top_10 lb_txt_color_white2'>
                Raised <span className='lb_txt_size_15'>2,686,660 USDT</span>{" "}
                out of <span className='lb_txt_size_15'>3,075,000 USDT</span>
              </div>
              <div className='lb_txt_size_12 lb_padding_top_10 lb_txt_color_white2'>
                Sold <span className='lb_txt_size_15'>138,051,106 $GVERSE</span>{" "}
                out of{" "}
                <span className='lb_txt_size_15'>150,000,000 $GVERSE</span>
              </div>
