...
const TrailerSection = () => {
    return(
        <div className=" lb_trailer_vid_padding bg-black-1" data-v-2a374f33="">
           ...
           <iframe  className="lb_trailer_vid lb_image_withine_glowBorderDiv" src="https://www.youtube.com/embed/wAuoJYnd-CY?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
           </div>
        </div>
    )
}
