import './home.css';
import './home2.css';
import img_logo from '../img/gameLogo.png';
    ...
    return(
        <div className="container-fluid hero-bg" data-v-2a374f33="">
            ...
            <div className="row h-100 p-3" data-v-2a374f33="">
                <div className="col-12 col-lg-7 col-xl-10 mt-auto margin-b-up mb-xl-0" data-v-2a374f33=""><h1
                    className="heading-1 burbank text-uppercase text-white mb-xl-0 lb_txt_color_orange" data-v-2a374f33="">
                    <div className="text-yellow lb_txt_color_white">GreedyVerse </div> MAY THE GREEDIEST WIN!!  
                </h1>
